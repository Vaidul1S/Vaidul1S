...
- [**Team Generator**](https://github.com/Vaidul1S/code/tree/main/react_generator): A team generator app for android (React Native). [**Download App (raw APK file)**](https://github.com/Vaidul1S/code/blob/main/react_generator/team_generator.apk)
