...
- [**Team Generator**](https://github.com/Vaidul1S/code/tree/main/react_generator): A team generator app for android (React Native). [**Download App (APK)**](react_generator/team_generator.apk)
